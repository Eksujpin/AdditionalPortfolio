...
namespace BDSA2019.Assignment08.Models.Tests
{
    public class TaskRepositoryTests : IDisposable
    {
        ...
        [Fact]
        public async TaskTR Create_returns_Created_with_id()
        {
        ...
        [Fact]
        public async TaskTR Create_creates_a_task_with_title_and_description_and_state_New()
        {
            var task = new TaskCreateDTO
            {
                Title = "title",
        ...
        [Fact]
        public async TaskTR Create_assigns_user()
        {
            var task = new TaskCreateDTO
            {
                Title = "title",
        ...
        [Fact]
        public async TaskTR Create_given_non_existing_user_returns_Conflict_and_id_0()
        {
            var task = new TaskCreateDTO
            {
                Title = "title",
        ...
        [Fact]
        public async TaskTR Create_creates_and_assigns_tasks()
        {
            var task = new TaskCreateDTO
            {
                Title = "title",
        ...
        [Fact]
        public async TaskTR Read_given_id_returns_task_with_mapped_properties()
        {
        ...
        [Fact]
        public async TaskTR Read_given_returns_all_active_tasks_with_mapped_properties()
        {
            var tasks = await _repository.Read();
        ...
        [Fact]
        public async TaskTR Read_given_true_returns_all_tasks_with_mapped_properties()
        {
            var tasks = await _repository.Read(true);
        ...
        [Fact]
        public async TaskTR Update_given_non_existing_task_returns_NotFound()
        {
        ...
        [Fact]
        public async TaskTR Update_given_non_existing_user_returns_Conflict()
        {
            var task = new TaskUpdateDTO
            {
                Id = 1,
        ...
        [Fact]
        public async TaskTR Update_updates_all_properties_and_returns_updated()
        {
            var task = new TaskUpdateDTO
            {
                Id = 2,
        ...
        [Fact]
        public async TaskTR Delete_given_non_existing_task_returns_NotFound()
        {
        ...
        [Fact]
        public async TaskTR Delete_given_existing_New_task_returns_Deleted()
        {
        ...
        [Fact]
        public async TaskTR Delete_given_existing_New_task_deletes_task()
        {
        ...
        [Fact]
        public async TaskTR Delete_given_existing_Active_task_sets_state_to_Removed()
        {
        ...
        [Fact]
        public async TaskTR Delete_given_existing_Resolved_task_returns_Conflict()
        {
        ...
        [Fact]
        public async TaskTR Delete_given_existing_Closed_task_returns_Conflict()
        {
        ...
        [Fact]
        public async TaskTR Delete_given_existing_Removed_task_returns_Conflict()
        {
