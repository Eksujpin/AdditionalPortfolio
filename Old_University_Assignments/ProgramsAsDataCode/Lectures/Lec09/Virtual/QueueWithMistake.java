...
class QueueWithMistake {
  ...
  class SentinelLockQueue implements Queue {  
    ...
    //private final Node dummy = new Node(-444, null); exercise 9.3
    //private Node head = dummy, tail = dummy;         exercise 9.3
    
    public SentinelLockQueue (){ //exercise 9.3
        Node dummy = new Node(-444, null);
        head = dummy; 
        tail = dummy;
    }
